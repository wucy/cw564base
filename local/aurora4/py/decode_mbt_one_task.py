...
taskdir = '%s/%s/%s.1/decode.%s/' % (base, TSET, MY, CONFIG)
...
hte = 'htefiles/HTE.lat_decode'


hdecmd = '"sleep 2;./base/dtools/htest-hybrid -HVBIN ./base/bin/HDecode.hybrid %s %s %s decode.%s %s"' % (hte, TSET, MY, CONFIG, socket)
