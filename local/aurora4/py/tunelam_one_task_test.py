...
cmd1 = 'base/local/tools/genlamfile_one_task_test.sh %s %s %s %s %s %s %s %s' % (my_base, MLP, NUM_BASIS, LAMFILE, segmap_fn, ssta, send, tmp_mat)
print cmd1
os.system(cmd1)


cmd2 = './base/local/py/matlab_tunelam_one_task_part_test.py %s %s %s %s %s %s' % (my_base, MY, LAMFILE, NUM_BASIS, MLP, tmp_mat)
print cmd2
os.system(cmd2)
