...
cmd1 = 'base/local/tools/genlamfile_one_task_multilam.sh %s %s %s %s %s %s %s %s %s %s' % (my_base, MLP, NUM_BASIS, LAMFILE, segmap_fn, ssta, send, tmp_mat, NUM_RGC, STA2CLS)
print cmd1
os.system(cmd1)
