...
qncmd = '"./base/local/ntools/QN_qnmultifwd.net.sh -TRNSTA %s -TRNEND %s -ACCELERATE none -THREADNUM 1 htefiles/HTE.mbt %s %s %s %s %s %s %s %s"' % (ssta, send, MLP, fea_pfile, tmp_pfile, my_base, socket, segmap_fn, LAMFILE, NUM_BASIS)
