...
weights45 = func_block_diag_mat(weights45, num_basis);
weights56 = func_block_diag_mat(weights56, num_basis);

bias2 = repmat(bias2, [1, num_basis]);
bias3 = repmat(bias3, [1, num_basis]);
bias4 = repmat(bias4, [1, num_basis]);
bias5 = repmat(bias5, [1, num_basis]);
bias6 = repmat(bias6, [1, num_basis]);

save -v4 NN.MAT weights12 bias2 weights23 bias3 weights34 bias4 weights45 bias5 weights56 bias6 weights67 bias7
