...
cmd1 = 'base/local/tools/genlamfile_one_task.sh %s %s %s %s %s %s %s' % (my_base, MLP, NUM_BASIS, LAMFILE, segmap_fn, ssta, send)
print cmd1
os.popen(cmd1)


cmd2 = './base/local/py/matlab_tunelam_one_task_part.py %s %s %s %s %s' % (my_base, MY, LAMFILE, NUM_BASIS, MLP)
print cmd2
