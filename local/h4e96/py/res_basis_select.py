...
NUM_BASIS = 2
logs = ['b1/LOG', 'b2/LOG']
mlfs_fn = ['../../scoring/sclite/dev03/decode.mbt.b1_rescore_tg_11.0_0.0.mlf.raw', '../../scoring/sclite/dev03/decode.mbt.b2_rescore_tg_11.0_0.0.mlf.raw']
...
for line in scps:
    ...
    if scores[0][raw_key] > scores[1][raw_key]:
        better_mlf = mlfs[0][search_key]
    else:
        better_mlf = mlfs[1][search_key]
